...
namespace comp
{
	...
	// Ign_3dfx.exe registers its window class as "Ignition" (RegisterClassA from the
	// USER32 import set). Confirmed from the proxy's own window enumeration log.
	#define WINDOW_CLASS_NAME "Ignition"
